...
class InvoiceService {
  ...
  static Future<void> generateAndSaveInvoicePDF(
    ...
    try {
      ...
      try {
        // Thử lấy thư mục Downloads trước
        downloadDir = await getExternalStorageDirectory();
      } catch (e) {
        // Nếu không có quyền, dùng Documents directory
        print('⚠️ Không thể lấy Downloads, dùng Documents: $e');
        downloadDir = await getApplicationDocumentsDirectory();
      }

      if (downloadDir == null) {
        throw Exception('Không thể lấy thư mục lưu file');
      }

      final file = File('${downloadDir.path}/Invoice_$bookingId.pdf');
