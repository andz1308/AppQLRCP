          ...
          if (raw is List<MovieReview>) {
            ...
            _reviews = raw
                .map(
                  (r) => r is MovieReview
                      ? r
                      : MovieReview.fromJson((r ?? {}) as Map<String, dynamic>),
                )
                .toList();
          } else {
            _reviews = [];
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    height: 300,
                    decoration: const BoxDecoration(color: AppTheme.lightGray),
                    child:
                        widget.movie.image != null &&
                            widget.movie.image!.isNotEmpty
                        ? Image.network(
                            widget.movie.image!,
                            fit: BoxFit.cover,
                            width: double.infinity,
